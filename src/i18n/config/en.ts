export default {
    messages: {
        ...
        home: {
            ...
            provide_product: "CoinFlake makes it easy for anyone to buy and sell cryptocurrencies like Bitcoin, Ethereum and many more. At CoinFlake we offer a non-custodial service - meaning your crypto is your crypto. We do not hold on to funds and you choose where you keep your assets safe.",
            eighth_based: "Where is Coinflake based?",
            base_content: "Founded in 2024, Coinflake is a Australia-registered cryptocurrency exchange. We provide the latest trading services for hundreds of diverse crypto assets in P2P markets.",
        ...
        pay_order: {
            ...
            third_note: "This service is supported by CoinFlake, in accordance to CoinFlake's",
            appeal: "Appeal",
            receive: "You Receive",
        },
        deposit_Fiat: {
            ...
            trans_3: "This service is supported by CoinFlake, in accordance to CoinFlake's ",
            term: "Terms of Use",
            and: "and",
            privacy: "Privacy Policy.",
